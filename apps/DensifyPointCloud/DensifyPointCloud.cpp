...
bool Initialize(size_t argc, LPCTSTR* argv)
{
	...
	config.add_options()
		...
		("ransac-cluster", boost::program_options::value(&fransacClusterMul)->default_value(4), "value to which avg_spacing will be multiplied for cluster")
		("ransac-min-points", boost::program_options::value(&fransacMinPointsDiv)->default_value(100), "value to which total points will be divided for min points")
		;
